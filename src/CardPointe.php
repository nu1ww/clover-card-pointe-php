...
use Nu1ww\CardConnect\Responses\CaptureResponse;
use Nu1ww\CardConnect\Responses\InquireResponse;
use Nu1ww\CardConnect\Responses\RefundResponse;
use Nu1ww\CardConnect\Responses\Response;
use Nu1ww\CardConnect\Responses\SettlementResponse;
use Nu1ww\CardConnect\Responses\VoidResponse;
...
class CardPointe
{
     ...
     * @param bool $isWallet
     */
    public function __construct($merchant, $user, $pass, $endpoint, $currency = 'USD', $isWallet = false)
    {
     ...
     *
     * @return \Nu1ww\CardConnect\Responses\Response
     */
     ...
     * @return \Nu1ww\CardConnect\Responses\AuthorizationResponse|\Nu1ww\CardConnect\Responses\CaptureResponse
     */
     ...
     *
     * @return \Nu1ww\CardConnect\Responses\CaptureResponse
     */
     ...
     * @param array  $request request parameters
     *
     * @return \Nu1ww\CardConnect\Responses\VoidResponse
     */
     ...
     * @param array $request request parameters
     *
     * @return \Nu1ww\CardConnect\Responses\RefundResponse
     */
     ...
     *
     * @return \Nu1ww\CardConnect\Responses\InquireResponse
     */
     ...
     */
    public function tokenizeGooglePay($request)
    {
        $params = [
            'merchid' => $this->merchant_id,
     ...
     * @return CaptureResponse
     */
    public function tokenizeApplePay($request)
    {
        $params = [
            'merchid' => $this->merchant_id,
